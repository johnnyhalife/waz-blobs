...
=== Remarks
Since Windows Azure Blob Storage API doesn't support blobs on the _root container_, there's no support like S3 to put a blob *without a container relationship*, 
